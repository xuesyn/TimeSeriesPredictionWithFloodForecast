...
def evaluate_model(
    ...
    if "probabilistic" in inference_params:
        ...
        print("skipping summary plot and heatmap")
...
def generate_decoded_predictions(
    ...
    probabilistic = False
    scaler = None
    # print("stage_gen_decoder_pret_1")
    if test_data.no_scale:
        # print("stage_gen_decoder_pret_2")
        scaler = test_data
    if decoder_params is not None:
        # print("stage_gen_decoder_pret_3")
        if "probabilistic" in decoder_params:
            probabilistic = True
        ...
        # print("stage_gen_decoder_pret_4")
        if targs:
            # print("stage_gen_decoder_pret_5")
            src = history_dim
            src0 = src[0]
            trg = targs
            decoder_seq_len = model.params["model_params"]["label_len"]
            # print("stage_gen_decoder_pret_6")
            ...
            # print("stage_gen_decoder_pret_7")
