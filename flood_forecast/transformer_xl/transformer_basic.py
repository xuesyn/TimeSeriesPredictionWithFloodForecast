...
def greedy_decode(
    ...
    """
    #print("step71 max_len:",max_len)
    src = src.float()
    real_target = real_target.float()
    if hasattr(model, "mask"):
        #print("step72")
        src_mask = model.mask
    #print("step73 src:",src.shape," src_mask:",src_mask.shape)
    #print("size_mask:",src_mask.shape)
    #print("size_src:",src.shape)
    #print(src_mask)
