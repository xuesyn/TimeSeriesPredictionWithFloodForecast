...
def _prepare_background_tensor(
    ...
    print("background_batch:",background_batches[:1])
    print("size of background_batch",len(background_batches[:-1]))
    print("background_batch_size",backgound_batch_size)
